    ...
    public static ReplyKeyboardMarkup generateMarkup(TgUser user) {
        ...
        if (user.getBotState().equals(BotState.SHARE_CONTACT)) {
            ...
            rowList.add(row2);
                ...
                user.getBotState().equals(BotState.TWO) ||
                user.getBotState().equals(BotState.THREE) ||
                user.getBotState().equals(BotState.FOUR) ||
                user.getBotState().equals(BotState.FIVE)){
            KeyboardButton row1button2 = new KeyboardButton();
...
//    }
    ...
    public static InlineKeyboardMarkup inlineKeyboardMarkup(TgUser user) {
        ...
        if (user.getBotState().equals(BotState.SHOW_ADMIN_MENU)) {
            ...
            InlineKeyboardButton row2button1 = new InlineKeyboardButton();
            InlineKeyboardButton row2button2 = new InlineKeyboardButton();
            row2button1.setText("\uD83C\uDDF7\uD83C\uDDFARussian-\uD83C\uDDEC\uD83C\uDDE7English");
            row2button1.setCallbackData("Russian-English");
            row2button2.setText("\uD83C\uDDEC\uD83C\uDDE7English-\uD83C\uDDF7\uD83C\uDDFARussian");
            row2button2.setCallbackData("English-Russian");
            row2.add(row2button1);
            row2.add(row2button2);
            rowList.add(row2);
            ...
            row3button1.setText("\uD83C\uDDFA\uD83C\uDDFFUzbek-\uD83C\uDDF7\uD83C\uDDFARussian");
            row3button1.setCallbackData("Uzbek-Russian");
            row3button2.setText("\uD83C\uDDF7\uD83C\uDDFARussian-\uD83C\uDDFA\uD83C\uDDFFUzbek");
            row3button2.setCallbackData("Russian-Uzbek");
            row3.add(row3button1);
            ...
            row1.add(row1button1);
            rowList.add(row1);
        } else if (user.getBotState().equals(BotState.ANSWERING_COMPLAINTS_OR_OFFERS)) {
            ...
            if(Database.complaintsOrOffersList.size() == 1) {
                row1button1.setText("1");
                row1button1.setCallbackData("1");
                row1.add(row1button1);
                rowList.add(row1);
            }else if(Database.complaintsOrOffersList.size() == 2) {
                row1button1.setText("1");
                row1button1.setCallbackData("1");
                row1.add(row1button1);
                row1button2.setText("2");
                row1button2.setCallbackData("2");
                row1.add(row1button2);
                rowList.add(row1);
            }else if(Database.complaintsOrOffersList.size() == 3) {
                row1button1.setText("1");
                row1button1.setCallbackData("1");
                row1.add(row1button1);
                row1button2.setText("2");
                ...
                row1button3.setCallbackData("3");
                row1.add(row1button3);
                rowList.add(row1);
            }else if(Database.complaintsOrOffersList.size() == 4) {
                row1button1.setText("1");
                row1button1.setCallbackData("1");
                row1.add(row1button1);
                row1button2.setText("2");
                ...
                row1button4.setCallbackData("4");
                row1.add(row1button4);
                rowList.add(row1);
            }else if(Database.complaintsOrOffersList.size() == 5) {
                row1button1.setText("1");
                row1button1.setCallbackData("1");
                row1.add(row1button1);
                row1button2.setText("2");
    ...
    public static SendPhoto advertPhoto(TgUser user) {
        ...
        if (Database.tgUserList.size() > 1) {
            File file = new File("D:\\enter.jpg");
            InputFile inputFile = new InputFile(file);
            sendPhoto.setPhoto(inputFile);
    ...
    public static SendMessage ruEn(TgUser tgUser) {
        tgUser.setBotState(BotState.RUSSIAN_ENGLISH);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("✏️Please enter word...");
        tgUser.setBotState(BotState.RUSSIAN_ENGLISH1);
        saveUserChanges(tgUser);
        return sendMessage;
    }
    ...
    public static SendMessage enRu(TgUser tgUser) {
        tgUser.setBotState(BotState.ENGLISH_RUSSIAN);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("✏️Please enter word...");
        tgUser.setBotState(BotState.ENGLISH_RUSSIAN1);
        saveUserChanges(tgUser);
        return sendMessage;
    }
    ...
    public static SendMessage uzRu(TgUser tgUser) {
        tgUser.setBotState(BotState.UZBEK_RUSSIAN);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("✏️Please enter word...");
        tgUser.setBotState(BotState.UZBEK_RUSSIAN1);
        saveUserChanges(tgUser);
        return sendMessage;
    }
    ...
    public static SendMessage ruUz(TgUser tgUser) {
        tgUser.setBotState(BotState.RUSSIAN_UZBEK);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("✏️Please enter word...");
        tgUser.setBotState(BotState.RUSSIAN_UZBEK1);
        saveUserChanges(tgUser);
        return sendMessage;
    }
    ...
    public static SendMessage sendAnswer1(TgUser user, Update update){
        user.setBotState(BotState.SEND_ANSWER1);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(Database.complaintsOrOffersList.get(0).getTgUser().getChatId());
        sendMessage.setText("❓Your question : "+Database.complaintsOrOffersList.get(0).getText()+
                "❗️Our answer: "+update.getMessage().getText());
        saveUserChanges(user);
        return sendMessage;
    }
    ...
    //DELETE 1 method***************************
    public static SendMessage deleteOne(TgUser tgUser) {
        tgUser.setBotState(BotState.DELETE_ONE);
        Database.complaintsOrOffersList.remove(0);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
    ...
    //SEND ANSWER TWO method***********************************
    public static SendMessage sendAnswerTwo(TgUser tgUser) {
        tgUser.setBotState(BotState.SEND_ANSWER_TWO);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("You may write your answers here...");
        tgUser.setBotState(BotState.SEND_ANSWER2);
        saveUserChanges(tgUser);
        return sendMessage;
    }


    //SEND ANSWER 2 method************************************
    public static SendMessage sendAnswer2(TgUser user, Update update){
        user.setBotState(BotState.SEND_ANSWER2);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(Database.complaintsOrOffersList.get(1).getTgUser().getChatId());
        sendMessage.setText("❓Your question : "+Database.complaintsOrOffersList.get(1).getText()+
                "❗️Our answer: "+update.getMessage().getText());
        saveUserChanges(user);
        return sendMessage;
    }
    ...
    //DELETE 2 method***************************
    public static SendMessage deleteTwo(TgUser tgUser) {
        tgUser.setBotState(BotState.DELETE_TWO);
        Database.complaintsOrOffersList.remove(1);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("Deleted");
        saveUserChanges(tgUser);
    ...
    //SEND ANSWER THREE method***********************************
    public static SendMessage sendAnswerThree(TgUser tgUser) {
        tgUser.setBotState(BotState.SEND_ANSWER_THREE);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("You may write your answers here...");
        tgUser.setBotState(BotState.SEND_ANSWER3);
        saveUserChanges(tgUser);
        return sendMessage;
    }


    //SEND ANSWER 3 method************************************
    public static SendMessage sendAnswer3(TgUser user, Update update){
        user.setBotState(BotState.SEND_ANSWER3);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(Database.complaintsOrOffersList.get(2).getTgUser().getChatId());
        sendMessage.setText("❓Your question : "+Database.complaintsOrOffersList.get(2).getText()+
                "❗️Our answer: "+update.getMessage().getText());
        saveUserChanges(user);
        return sendMessage;
    }
    ...
    //DELETE 3 method***************************
    public static SendMessage deleteThree(TgUser tgUser) {
        tgUser.setBotState(BotState.DELETE_THREE);
        Database.complaintsOrOffersList.remove(2);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("Deleted");
        saveUserChanges(tgUser);
    ...
    //SEND ANSWER FOUR method***********************************
    public static SendMessage sendAnswerFour(TgUser tgUser) {
        tgUser.setBotState(BotState.SEND_ANSWER_FOUR);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("You may write your answers here...");
        tgUser.setBotState(BotState.SEND_ANSWER4);
        saveUserChanges(tgUser);
        return sendMessage;
    }


    //SEND ANSWER 4 method************************************
    public static SendMessage sendAnswer4(TgUser user, Update update){
        user.setBotState(BotState.SEND_ANSWER4);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(Database.complaintsOrOffersList.get(3).getTgUser().getChatId());
        sendMessage.setText("❓Your question : "+Database.complaintsOrOffersList.get(3).getText()+
                "❗️Our answer: "+update.getMessage().getText());
        saveUserChanges(user);
        return sendMessage;
    }
    ...
    //DELETE 4 method***************************
    public static SendMessage deleteFour(TgUser tgUser) {
        tgUser.setBotState(BotState.DELETE_TWO);
        Database.complaintsOrOffersList.remove(3);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("Deleted");
        saveUserChanges(tgUser);
    ...
    //SEND ANSWER FIVE method***********************************
    public static SendMessage sendAnswerFive(TgUser tgUser) {
        tgUser.setBotState(BotState.SEND_ANSWER_FIVE);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("You may write your answers here...");
        tgUser.setBotState(BotState.SEND_ANSWER5);
        saveUserChanges(tgUser);
        return sendMessage;
    }


    //SEND ANSWER 5 method************************************
    public static SendMessage sendAnswer5(TgUser user, Update update){
        user.setBotState(BotState.SEND_ANSWER5);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(Database.complaintsOrOffersList.get(4).getTgUser().getChatId());
        sendMessage.setText("❓Your question : "+Database.complaintsOrOffersList.get(4).getText()+
                "❗️Our answer: "+update.getMessage().getText());
        saveUserChanges(user);
        return sendMessage;
    }
    ...
    //DELETE 5 method***************************
    public static SendMessage deleteFive(TgUser tgUser) {
        tgUser.setBotState(BotState.DELETE_FIVE);
        Database.complaintsOrOffersList.remove(4);
        SendMessage sendMessage = new SendMessage();
        sendMessage.setChatId(tgUser.getChatId());
        sendMessage.setText("Deleted");
        saveUserChanges(tgUser);
    ...
    public static SendMessage two(TgUser tgUser) {
    ...
    public static SendMessage three(TgUser tgUser) {
    ...
    public static SendMessage four(TgUser tgUser) {
    ...
    public static SendMessage five(TgUser tgUser) {
